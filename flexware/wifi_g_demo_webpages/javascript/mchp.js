...
{	
	...
	else // either index.htm or nothing (xxx.xxx.xxx.xxx gives no page name) 
	{
		...
		if(getXMLValue(xmlData, 'btn1') == 'up')
			document.getElementById('btn1').innerHTML = '&Lambda;';
		else
			document.getElementById('btn1').innerHTML = 'V';
		
		}
		
}
 
 function updateTemp(xmlData){

  document.getElementById('placeholder').innerHTML = getXMLValue(xmlData,'NodeTemp1');

 }
 
 function getTemp(xmlData){
...
//value,the passed parameter
//between Celsius or Fahrenheit
//=============================
function change( )
{
    if ( document.getElementById("CorF").value == "Celcius" )
        {
		document.getElementById("CorF").value = "Fahrenheit";
		}
    else
		{
        document.getElementById("CorF").value = "Celcius";
		}
}
