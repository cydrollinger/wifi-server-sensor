...
const static FIT_SOFTWARE_MESG_DEF software_mesg_def =
{
   ...
   { // field_def_num, size, base_type
      ...
      FIT_SOFTWARE_FIELD_NUM_MANUFACTURER, (sizeof(FIT_MANUFACTURER)*1), FIT_BASE_TYPE_UINT16,
      FIT_SOFTWARE_FIELD_NUM_PRODUCT, (sizeof(FIT_UINT16)*1), FIT_BASE_TYPE_UINT16,
   }
};
